...
void h_push(stack_t **head, unsigned int number);
void h_pall(stack_t **head, unsigned int number);
void h_pint(stack_t **head, unsigned int number);
...
void h_rotl(stack_t **head, unsigned int counter);
